...
class PreregistrationParticipants(models.Model):
    ...
    participant_own_transport_to_camp_total  = fields.Integer('No. own transport to camp', required=True)
    participant_own_transport_from_camp_total  = fields.Integer('No. own transport from camp', required=True)
    participant_common_transport_to_camp_total  = fields.Integer(compute = '_calculate_common_transport', string='No. Common transport to camp')
    participant_common_transport_from_camp_total  = fields.Integer(compute = '_calculate_common_transport', string='No. Common transport from camp')
