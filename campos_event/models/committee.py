...
class CampCommittee(models.Model):
    ...
    access_grp_staff_ids = fields.Many2many('res.groups', relation='rel_comm_staff_group', string='Staff Access Groups', groups='campos_event.group_campos_admin')
    access_grp_mgr_ids = fields.Many2many('res.groups', relation='rel_comm_mgr_group', string='Mgr Access Groups', groups='campos_event.group_campos_admin')
