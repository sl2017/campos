...
class Projectissue(models.Model):
    ...
    def _get_origin(self):
        if self.model_reference:
            ...
            if rec_name:
                self.issue_origin = self.model_reference.display_name
    ...
    def _authorised_models(self):
        ...
        """
        models = self.env['ir.model'].search([('model', '!=', 'project.issue')])
    ...
    issue_origin = fields.Char(compute='_get_origin')
...
class IrActionActWindows(models.Model):
    ...
    def read(self, cr, uid, ids, fields=None, context=None,
        ...
        issue_action_id = self.pool['ir.model.data'].xmlid_to_res_id(
            cr, SUPERUSER_ID,
            'project_model_to_issue.issue_from_elsewhere')
