...
project = u'Camp OS'
copyright = u'2015, Spejdernes Lejr 2017'
...
latex_documents = [
    ('index', 'SGMember.tex', u'SG Member Documentation',
     u'Stein & Gabelgaard ApS', 'manual'),
]
...
man_pages = [
    ('index', 'sgmember', u'SG Member Documentation',
     [u'Stein & Gabelgaard'], 1)
]
