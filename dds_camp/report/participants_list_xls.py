...
_ir_translation_name = 'dds_camp.event.participant.xls'


class dds_camp_event_participant_xls_parser(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(dds_camp_event_participant_xls_parser, self).__init__(cr, uid, name, context=context)
        par_obj = self.pool.get('dds_camp.event.participant')
        self.context = context
        wanted_list = par_obj._report_xls_fields(cr, uid, context)
        template_changes = par_obj._report_xls_template(cr, uid, context)
...
#                 'totals': [1, 0, 'text', None]},
             'birth': {
                'header': [1, 13, 'text', _render("_('Birth Date')")],
                'lines': [1, 0, 'text', _render("line.birth if line.birth else ''")],
                #'lines': [1, 0, _render("line.birth and 'date' or 'text'"),
                #     _render("line.birth and datetime.strptime(line.birth,'%Y-%m-%d') or None"), None, self.aml_cell_style_date],
                'totals': [1, 0, 'text', None]},
              'street': {
                'header': [1, 42, 'text', _render("_('Street')")],
                'lines': [1, 0, 'text', _render("line.street or ''")],
                'totals': [1, 0, 'text', None]},
              'street2': {
                'header': [1, 42, 'text', _render("_('Street2')")],
                'lines': [1, 0, 'text', _render("line.street2 or ''")],
                'totals': [1, 0, 'text', None]},
               'zip': {
                'header': [1, 42, 'text', _render("_('Zip')")],
                'lines': [1, 0, 'text', _render("line.zip or ''")],
                'totals': [1, 0, 'text', None]},         
               'city': {
...
dds_camp_event_participant_xls('report.dds_camp.event.participant.xls',
    'dds_camp.event.participant',
    parser=dds_camp_event_participant_xls_parser)
